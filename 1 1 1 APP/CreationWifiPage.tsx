...
export default function CreationWifiPage({ rootJson }: CreationParams) {
  ...
  const onPressBack = () => {
    history.push(`.${CreationRoutes.BASIC}`);
  };
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    // Set default value.
    rootJson.wifiInfo_skipMacRandomization = 'off';
    rootJson.wifiInfo_hidden = 'off';
    ...
    rootJson.wifiInfo_skipMacRandomization =
      rootJson.wifiInfo_skipMacRandomization === 'off';
    ...
    return (
      <div className={`${styles.formfield}  ${styles.indent}`}>
        ...
        <div className={styles.uploadCertificateContainer}>
          <div className={styles.uploadCertificateBtn}>
            <label
              htmlFor="upload_user_certificate"
              className={styles.uploadCertificateBtnText}
            >
              {UPLOAD_CA_FILE}
            </label>
