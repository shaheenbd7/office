...
export const PASSCODE_FORM_STRINGS = {
  ...
  DESCRIPTION1: 'Enter passcode.',
  DESCRIPTION2: 'If you forgot your passcode, Click on ',
  BACKUP_CODE_LINK: 'here.',
...
export const DEVICE_OWNER_SUMMARY_FORM_STRINGS = {
  ...
  GENERAL_SOUND: '3. Sound',
  GENERAL_SYSTEM: '4. System Language & Country',
};
