...
public class RecordsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recordList.add(new Record("You updated in N8", "You owe BDT 12345", "22 Nov 2020"));
        recordList.add(new Record("You updated in N8", "You owe BDT 12345", "22 Nov 2020"));
        recordList.add(new Record("You updated in N8", "You owe BDT 12345", "22 Nov 2020"));
        recordList.add(new Record("You updated in N8", "You owe BDT 12345", "22 Nov 2020"));
        recordList.add(new Record("You updated in N8", "You owe BDT 12345", "22 Nov 2020"));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewRecord = v.findViewById(R.id.recycler_view_people);
        AdapterRecord adapterRecord = new AdapterRecord(getContext(), recordList);
